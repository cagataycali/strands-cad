...
TOOL_GROUPS: dict[str, tuple[str, list[str]]] = {
    ...
    "printability": ("strands_cad.tools.printability",
                     ["stl_printability", "stl_orient", "stl_check_clearance"]),
    "mesh_gen": ("strands_cad.tools.mesh_gen",
                 ["mesh_from_text", "mesh_from_svg", "mesh_from_image"]),
    ...
    "bambu": ("strands_cad.tools.bambu",
              ["bambu_connect", "bambu_send", "bambu_upload", "bambu_status",
